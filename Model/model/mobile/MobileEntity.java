...
public class MobileEntity extends Element{
	...
	public MobileEntity(int xSpritePos, int ySpritePos, int nbSprites, String name, Opacity opacity, HitBoxe hitboxe,  Position position,int widthFrame, int heightFrame, int widthDisplay, int heightDisplay) {
		super(xSpritePos, ySpritePos, nbSprites, opacity, hitboxe, name,  widthFrame, heightFrame, widthDisplay, heightDisplay, position);
