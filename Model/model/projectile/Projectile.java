...
public class Projectile extends Element{
	...
	/*------------------------------------------------------------------------------*/
	public Projectile(int xImagePos, int yImagePos, int nbSprites, Opacity opacity,HitBoxe hitboxe,  String name, int widthFrame,
			int heightFrame, int widthDisplay, int heightDisplay, Position position, Direction direction, Projectiles typeProjectile) {
		super(xImagePos, yImagePos, nbSprites, opacity, hitboxe, name, widthFrame, heightFrame, widthDisplay, heightDisplay, position);
