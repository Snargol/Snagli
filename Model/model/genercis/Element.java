...
public abstract class Element {
	...
	/*------------------------------------------------------------------------------*/
	public Element( int xImagePos, int yImagePos, int nbSprites, Opacity opacity ,HitBoxe hitboxe,String name, int widthFrame, int heightFrame, int widthDisplay, int heightDisplay, Position position) {
		setOpacity(opacity);
	...
	public Element( int xImagePos, int yImagePos, int nbSprites, Opacity opacity, HitBoxe hitboxe,String file,String name, int widthFrame, int heightFrame, int widthDisplay, int heightDisplay, Position position) {
		setOpacity(opacity);
		setPosition(position);
		setHitboxe(hitboxe);
